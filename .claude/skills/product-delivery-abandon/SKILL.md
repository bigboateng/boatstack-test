...
description: "Explicitly abandon the selected delivery before starting different work Use only when the user explicitly selects this repository Flow entry."
---
...
Start with `boatstack next --repo . --flow product-delivery --entry abandon --host claude --format json`.
