...
Start with `boatstack flow run --repo . --flow product-delivery --entry run --repository-authority --host gemini --format json`.
...
`boatstack flow authorize --repo . --flow product-delivery --entry run --run-id <run-id> --request-fingerprint <fingerprint> --human-identity-provider-fingerprint <provider-fingerprint> --human <actor> --host gemini`

After authorization, use `boatstack flow run --repo . --flow product-delivery --entry run --run-id <run-id> --repository-authority --host gemini --format json`.
...
`boatstack flow work input-required --repo . --flow product-delivery --entry run --run-id <run-id> --work-id <work-id> --prompt <question> --host gemini --format json`
...
`boatstack flow input show --repo . --flow product-delivery --entry run --run-id <run-id> --request-fingerprint <fingerprint> --host gemini --format json`
...
`boatstack flow input answer --repo . --flow product-delivery --entry run --run-id <run-id> --request-fingerprint <fingerprint> --answer <json-path> --human <actor> --host gemini --format json`
...
`boatstack flow input supersede --repo . --flow product-delivery --entry run --run-id <run-id> --request-fingerprint <fingerprint> --reason <semantic-rejection> --human <actor> --host gemini --format json`
...
`boatstack reconcile-update --repo . --flow product-delivery --entry run --run-id <run-id> --accept-program-change --human <actor> --host gemini --format json`
