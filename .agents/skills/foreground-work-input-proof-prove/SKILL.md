...
Start with `boatstack flow run --repo . --flow foreground-work-input-proof --entry prove --repository-authority --host codex --format json`.
...
`boatstack flow authorize --repo . --flow foreground-work-input-proof --entry prove --run-id <run-id> --request-fingerprint <fingerprint> --human-identity-provider-fingerprint <provider-fingerprint> --human <actor> --host codex`

After authorization, use `boatstack flow run --repo . --flow foreground-work-input-proof --entry prove --run-id <run-id> --repository-authority --host codex --format json`.
...
`boatstack flow work input-required --repo . --flow foreground-work-input-proof --entry prove --run-id <run-id> --work-id <work-id> --prompt <question> --host codex --format json`
...
`boatstack reconcile-update --repo . --flow foreground-work-input-proof --entry prove --run-id <run-id> --accept-program-change --human <actor> --host codex --format json`
