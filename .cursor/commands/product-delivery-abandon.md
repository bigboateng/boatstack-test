...
Start with `boatstack flow run --repo . --flow product-delivery --entry abandon --repository-authority --host cursor --format json`.
...
`boatstack flow authorize --repo . --flow product-delivery --entry abandon --run-id <run-id> --request-fingerprint <fingerprint> --human-identity-provider-fingerprint <provider-fingerprint> --human <actor> --host cursor`

After authorization, use `boatstack flow run --repo . --flow product-delivery --entry abandon --run-id <run-id> --repository-authority --host cursor --format json`.
...
`boatstack flow work input-required --repo . --flow product-delivery --entry abandon --run-id <run-id> --work-id <work-id> --prompt <question> --host cursor --format json`
...
`boatstack flow input show --repo . --flow product-delivery --entry abandon --run-id <run-id> --request-fingerprint <fingerprint> --host cursor --format json`
...
`boatstack flow input answer --repo . --flow product-delivery --entry abandon --run-id <run-id> --request-fingerprint <fingerprint> --answer <json-path> --human <actor> --host cursor --format json`
...
`boatstack flow input supersede --repo . --flow product-delivery --entry abandon --run-id <run-id> --request-fingerprint <fingerprint> --reason <semantic-rejection> --human <actor> --host cursor --format json`
...
`boatstack reconcile-update --repo . --flow product-delivery --entry abandon --run-id <run-id> --accept-program-change --human <actor> --host cursor --format json`
